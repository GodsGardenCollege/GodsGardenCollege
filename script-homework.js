...
const users = {
  ...
  "Mr. Anonye": { password: "", role: "teacher", subjects: ["Computer", "CRS"] },
  "Miss Deborah": { password: "12", role: "teacher", subjects: ["HomeEconomics", "BusinessStudies"] },
  "Mr. Ken": { password: "28", role: "teacher", subjects: ["Geography", "Marketing", "CCA"] },
  "Mr. Stanley": { password: "S", role: "teacher", subjects: ["Agric", "Biology"] },
  "Mr. Emmanuel": { password: "E7", role: "teacher", subjects: [""] },
  "Mr. Chimezie": { password: "M8", role: "teacher", subjects: ["Mathematics", "Physics"] },
  "Miss Favour": { password: "Fa3", role: "teacher", subjects: ["Chemistry", "BasicScience"] },
  "Miss Irene": { password: "I9", role: "teacher", subjects: ["CivicEducation"] },
  "Miss Chinenye": { password: "role", role: "teacher", subjects: ["SocialStudies"] },
  "Miss Chidimma": { password: "9", role: "teacher", subjects: ["English", "Literature"] },
  "Mr. Paul": { password: "@20", role: "teacher", subjects: [""] },
  "Miss Ifenyinwa": { password: "If$78", role: "teacher", subjects: ["Economics"] },
  "Admin": { password: "08024385598", role: "admin" }
};
